...
def load_image_ids(split_name):
    ...
    if split_name == 'coco_test2014':
      with open('/home/hantao/HantaoHuang/project/VQA_AAAI2019/data/mscoco/annotations/image_info_test2014.json') as f:
        data = json.load(f)
      ...
      with open('/home/hantao/HantaoHuang/project/VQA_AAAI2019/data/mscoco/annotations/image_info_test2015.json') as f:
        data = json.load(f)
        for item in data['images']:
          image_id = int(item['id'])
